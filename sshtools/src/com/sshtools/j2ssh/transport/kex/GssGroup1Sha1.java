          ...
          e = g.modPow(x, p);*/
			...
			GSSContext gsscontext = null;
        	  if(theCredential==null) {
        		  ...
        		  try {
        			  //Cerlane : To support VOMS proxy type 4
        	...
        	//GlobusGSSManagerImpl globusgssmanagerimpl = new GlobusGSSManagerImpl();
        	  gsscontext = new BCGSSContextImpl(targetName, (GlobusGSSCredentialImpl) gsscredential);
        		  //globusgssmanagerimpl.createContext(targetName, GSSConstants.MECH_OID,gsscredential,GSSCredential.DEFAULT_LIFETIME );

        	  gsscontext.requestLifetime(GSSCredential.DEFAULT_LIFETIME);
