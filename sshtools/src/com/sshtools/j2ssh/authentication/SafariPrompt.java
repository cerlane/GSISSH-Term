...
public class SafariPrompt
{
    class SafariDialog extends JDialog
    {
	    ...
	    JLabel jlab = new JLabel("Your keystore passphrase is needed to access "+theDesc+" certificate store");
            ...
            UIUtil.jGridBagAdd(jpanel, new JLabel("Keystore Passphrase: "), gridbagconstraints, -1);
	...
	if(component==null) component=parent;
        ...
        SafariDialog gridproxyinitdialog = null;
        if(window instanceof Frame)
            gridproxyinitdialog = new  SafariDialog((Frame)window);
        else
        if(window instanceof Dialog)
            gridproxyinitdialog = new  SafariDialog((Dialog)window);
        else
            gridproxyinitdialog = new  SafariDialog();
    ...
    public static SafariPrompt getInstance()
    {
        if(instance == null)
            instance = new SafariPrompt();
        return instance;
    }
    ...
    private static SafariPrompt instance;
    private Component parent;
    private String title="Safari (Keychain Access) Certificate Store";
