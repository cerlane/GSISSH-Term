...
public class ActiveTunnelsSessionPanel
  ...
  class StartAction
    ...
    //Cerlane (ALT to CTRL)
      putValue(Action.ACCELERATOR_KEY,
               KeyStroke.getKeyStroke(KeyEvent.VK_S, Keyboard_Modifier));
    }
  ...
  class RemoveAction
    ...
    //Cerlane (ALT to CTRL)
      putValue(Action.ACCELERATOR_KEY,
               KeyStroke.getKeyStroke(KeyEvent.VK_R, Keyboard_Modifier));
    }
  ...
  class StopImmediatelyAction
    ...
    //Cerlane (ALT to CTRL)
      putValue(Action.ACCELERATOR_KEY,
               KeyStroke.getKeyStroke(KeyEvent.VK_C, Keyboard_Modifier));
    }
  ...
  class EditTunnelsAction
    ...
    //Cerlane (ALT to CTRL)
      putValue(Action.ACCELERATOR_KEY,
               KeyStroke.getKeyStroke(KeyEvent.VK_E, Keyboard_Modifier));
    }
  ...
  class ToggleActiveChannelsAction
    ...
    //Cerlane (ALT to CTRL)
      putValue(Action.ACCELERATOR_KEY,
               KeyStroke.getKeyStroke(KeyEvent.VK_A, Keyboard_Modifier));
    }
