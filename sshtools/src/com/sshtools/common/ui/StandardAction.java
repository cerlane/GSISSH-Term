...
public abstract class StandardAction
  ...
  /**Cerlane add this to try to get a fixed modifier */
  public static int Keyboard_Modifier = getKeyboardModifier();
  public static int Tools_Keyboard_Modifier = getToolsKeyboardModifier();
  /**
  *
  *
  * @return
  */
  private static int getKeyboardModifier(){
  ...
  * @return
  */
  private static int getToolsKeyboardModifier(){
	  String osName = System.getProperty("os.name");
	  if (osName.startsWith("Mac OS")) {
