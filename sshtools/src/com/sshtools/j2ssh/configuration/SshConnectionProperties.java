...
public class SshConnectionProperties {
  ...
  /** Cerlane added */
  protected String pkcs12_location;
  ...
  public void setHost(String host) {
	//Cerlane: To handle empty spaces
    this.host = host.trim();
  }
  ...
  * @param host
  */
 public void setPKCS12_Location(String pkcs12_location) {
   this.pkcs12_location = pkcs12_location.trim();
 }
 /**
 *
 *
 * @return
 */
public String getPKCS12_Location() {
  return pkcs12_location;
}

  //End of added by cerlane
