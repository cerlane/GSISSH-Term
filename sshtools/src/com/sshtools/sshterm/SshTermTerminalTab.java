...
public class SshTermTerminalTab
  ...
  public void setConnectionProfile(SshToolsConnectionProfile profile) {
    ...
    //Added by Cerlane: changed default from vt100 preferences indicated in config.
    String termEnvVariable = PreferencesStore.get(SshTerminalPanel.PREF_TERMINAL_TERM, TerminalEmulation.VT100);
    ...
    colorPrinting.setSelected(profile.getApplicationPropertyBoolean(
        SshTerminalPanel.PROFILE_PROPERTY_COLOR_PRINTING, true));
  }
