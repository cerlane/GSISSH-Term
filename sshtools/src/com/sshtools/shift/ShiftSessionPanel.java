...
public class ShiftSessionPanel
  ...
  protected void initActions() {
    ...
    registerAction(up);
    map.put(KeyStroke.getKeyStroke(KeyEvent.VK_U, Keyboard_Modifier), up);
    ...
    map.put(KeyStroke.getKeyStroke(KeyEvent.VK_F, Keyboard_Modifier), favorite);
    ...
    listing.getInputMap(i).put(KeyStroke.getKeyStroke(KeyEvent.VK_RIGHT,
    		Keyboard_Modifier, false), "Forward");
