 ...
 *
 *  Copyright (C) 2010 Siew Hoon Leong (Cerlane)
 *
 ...
 */
public class DEISAAction
    extends StandardAction {
  private final static String ACTION_COMMAND_KEY_ABOUT = "deisa-command";
  private final static String NAME_ABOUT = "DEISA documentation";
  private final static String SMALL_ICON_ABOUT =
      "/com/sshtools/common/ui/deisa.png";
  private final static String LARGE_ICON_ABOUT = "";
  private final static int MNEMONIC_KEY_ABOUT = 'D';

  /**
   * Creates a new DEISAAction object.
   *
   * @param parent
   * @param application
   */
  public DEISAAction() {
    ...
    putValue(Action.LONG_DESCRIPTION,
             "Show DEISA interactive access documentation");
  ...
  public void actionPerformed(ActionEvent evt) {
       ...
       */
      BareBonesBrowserLaunch.openURL("http://www.deisa.eu/usersupport/user-documentation/interactive-access");
